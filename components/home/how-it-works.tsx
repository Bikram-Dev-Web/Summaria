...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: "AI Analysis",
    description:
      "Our Advanced AI analyzes your document to extract key insights",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    description: "Receive a concise, easy-to-read summary of your document",
  },
];
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 68.1% 47.5%, 58.3% 45.2%, 45.2% 34.5%, 29.4% 48.6%, 20.4% 61.8%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.9%, 74.1% 44.1%)",
            }}
          />
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 h-full">
        ...
        to-transparent group-hover:from-rose-500/20
        transition-colors"
        >
        ...
        <div className="flex flex-col flex-1 gap-1 justify-between">
          ...
          <p className="text-center text-gary-600 text-sm">{description}</p>
        </div>
      </div>
    </div>
  );
